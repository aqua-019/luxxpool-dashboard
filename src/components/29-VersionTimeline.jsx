...
function C29({ viewport, skin, ...data }) {
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <span style={{ fontSize: 9, fontWeight: 500, color: '#818cf8', letterSpacing: '0.08em', textTransform: 'uppercase' }}>#29</span>
            <span style={{ fontSize: 14, fontWeight: 500, color: c.br || '#e0e8f0', letterSpacing: '-0.03em' }}>Version timeline</span>
          </div>
        ...
        <div style={{ fontSize: 11, color: c.dim, lineHeight: 1.7 }}>v0.4.0 → v0.5.2 → v0.6.x development history</div>
