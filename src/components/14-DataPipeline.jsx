...
function C14({ viewport, skin, ...data }) {
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <span style={{ fontSize: 9, fontWeight: 500, color: '#93bbf0', letterSpacing: '0.08em', textTransform: 'uppercase' }}>#14</span>
            <span style={{ fontSize: 14, fontWeight: 500, color: c.br || '#e0e8f0', letterSpacing: '-0.03em' }}>Data pipeline</span>
          </div>
        ...
        <div style={{ fontSize: 11, color: c.dim, lineHeight: 1.7 }}>WebSocket → buffer → zustand → render flow</div>
