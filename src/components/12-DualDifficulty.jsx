...
function C12({ viewport, skin, network, history }) {
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <span style={{ fontSize: 9, fontWeight: 500, color: '#5b9bf0', letterSpacing: '0.08em', textTransform: 'uppercase' }}>#12</span>
            <span style={{ fontSize: 14, fontWeight: 500, color: c.br || '#e0e8f0', letterSpacing: '-0.03em' }}>Dual difficulty</span>
          </div>
        ...
        <div style={{ fontSize: 9, color: c.dim, marginTop: 8 }}>LTC stepped + DOGE rolling 24h average</div>
  
      </div>
    </div>
  );
}
export default memo(C12);