...
function C40({ viewport, skin, ...data }) {
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <span style={{ fontSize: 9, fontWeight: 500, color: '#c4b5fd', letterSpacing: '0.08em', textTransform: 'uppercase' }}>#40</span>
            <span style={{ fontSize: 14, fontWeight: 500, color: c.br || '#e0e8f0', letterSpacing: '-0.03em' }}>Component registry</span>
          </div>
        ...
        <div style={{ fontSize: 11, color: c.dim, lineHeight: 1.7 }}>40-component master index with scope tags</div>
        <div style={{ marginTop: 8, height: 2, borderRadius: 1, background: 'rgba(91,155,240,0.04)' }}>
          <div style={{ height: '100%', borderRadius: 1, width: '100%', background: '#c4b5fd', opacity: 0.15 }} />
        </div>
