import { useEffect, useMemo, Suspense, useCallback, Component } from 'react';
...
// ErrorBoundary — catches 3D/component crashes without killing the dashboard
class ErrorBoundary extends Component {
  constructor(props) { super(props); this.state = { hasError: false }; }
  static getDerivedStateFromError() { return { hasError: true }; }
  componentDidCatch(err, info) { console.warn('[LUXX] Component error caught:', err.message); }
    ...
    <>
      ...
      <div style={{
        ...
        <main style={{
          ...
          {/* 3D Background — only renders on high+ tier, error-safe */}
          ...
          {/* Share Particles — on high+ tier, error-safe */}
